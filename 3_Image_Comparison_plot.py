...
ground_image = cv2.imread("image_comparison/HR.png",0)
fibre_image = cv2.imread("image_comparison/LR0.png",0)
norm_img = cv2.imread("image_comparison/normalisation.png",0)
interp_img = cv2.imread("image_comparison/interpolation.png",0)
SR1_img  = cv2.imread("image_comparison/SR1_1.png",0)
SR4_img = cv2.imread("image_comparison/SR4_1.png",0)
